...
public class AppConstants {
    ...
    // action
    public static final String ACTION_FINISH_ACTIVITY = "com.moko.mkscannergw.action.finishActivity";
    public static final String ACTION_MODIFY_NAME = "com.moko.mkscannergw.action.ACTION_MODIFY_NAME";
