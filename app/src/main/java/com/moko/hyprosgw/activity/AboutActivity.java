...
import com.moko.hyprosgw.BaseApplication;
import com.moko.hyprosgw.R;
import com.moko.hyprosgw.base.BaseActivity;
import com.moko.hyprosgw.databinding.ActivityAboutBinding;
import com.moko.hyprosgw.utils.ToastUtils;
import com.moko.hyprosgw.utils.Utils;
...
public class AboutActivity extends BaseActivity<ActivityAboutBinding> {
    ...
    public void onFeedbackLog(View view) {
        if (isWindowLocked())
            return;
        File trackerLog = new File(BaseApplication.PATH_LOGCAT + File.separator + "HyprosGW.txt");
        File trackerLogBak = new File(BaseApplication.PATH_LOGCAT + File.separator + "HyprosGW.txt.bak");
        ...
        StringBuilder mailContent = new StringBuilder("HyprosGW_");
