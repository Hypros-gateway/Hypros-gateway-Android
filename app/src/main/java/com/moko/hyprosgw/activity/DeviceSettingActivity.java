...
import com.moko.hyprosgw.databinding.ActivityDeviceSettingBinding;
...
public class DeviceSettingActivity extends BaseActivity<ActivityDeviceSettingBinding> {
    ...
    public void onRebootDevice(View view) {
        ...
        dialog.setOnAlertConfirmListener(() -> {
            ...
            try {
                MQTTSupport.getInstance().publish(getTopic(), message, MQTTConstants.CONFIG_MSG_ID_REBOOT, appMqttConfig.qos);
            } catch (MqttException e) {
                e.printStackTrace();
            }
        });
