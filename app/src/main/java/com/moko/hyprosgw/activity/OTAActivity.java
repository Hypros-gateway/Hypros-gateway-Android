...
import com.moko.hyprosgw.databinding.ActivityOtaBinding;
...
import com.moko.hyprosgw.service.DfuService;
import com.moko.hyprosgw.utils.FileUtils;
...
public class OTAActivity extends BaseActivity<ActivityOtaBinding> implements MokoScanDeviceCallback {
    ...
    private final DfuProgressListener mDfuProgressListener = new DfuProgressListenerAdapter() {
        ...
        public void onDeviceConnecting(String deviceAddress) {
            ...
            if (mDeviceConnectCount > 3) {
                ToastUtils.showToast(OTAActivity.this, "Error:DFU Failed");
        ...
        public void onError(String deviceAddress, int error, int errorType, String message) {
            ...
            ToastUtils.showToast(OTAActivity.this, R.string.update_failed);
        }
    };
