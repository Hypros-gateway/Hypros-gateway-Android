package com.moko.hyprosgw.utils;
...
public class Utils {
     ...
     * @ClassPath com.moko.mkscannergw.utils.Utils
     */
    public static void sendEmail(Context context, String address, String body, String subject, String tips, File... files) {
        ...
        if (files.length == 1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                uri = FileProvider.getUriForFile(context, "com.moko.hyprosgw.fileprovider", files[0]);
